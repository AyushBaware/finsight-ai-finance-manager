      ...
      low: [
        {
          ...
          risk: "Very Low",
          description:
            "Secure government-backed savings with guaranteed returns.",
          reason:
            "Based on your conservative risk profile, FDs offer guaranteed growth.",
        ...
        },
        {
          ...
          risk: "No Risk",
          description:
            "Liquid savings with instant access and competitive interest rates.",
        ...
        },
        {
          ...
          reason:
            "Zero credit risk with decent returns for long-term wealth building.",
      ...
      medium: [
        {
          ...
          risk: "Medium",
          description:
            "Dynamic fund that balances equity and debt based on market conditions.",
        ...
        },
        {
          ...
          reason:
            "Diversified exposure to India's best companies with minimal fees.",
      ...
      high: [
        {
          ...
          risk: "High",
          description:
            "Aggressive growth fund focused on large-cap and mid-cap stocks.",
          reason:
            "Your high risk tolerance allows aggressive equity exposure for wealth creation.",
        ...
        },
        {
          ...
          reason:
            "Blue-chip stock with strong fundamentals and dividend potential.",
        ...
        },
        {
          ...
          risk: "Very High",
          description:
            "Emerging digital asset for speculative high-growth plays.",
          reason:
            "Only allocate what you can afford to lose; high volatility for high returns.",
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-sm opacity-90 mt-1">
              Personalized for your ₹{leftoverMoney.toLocaleString()} leftover
              funds
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="border-t border-purple-200 dark:border-purple-800 pt-3 mt-3">
            <p className="text-xs text-gray-600 dark:text-gray-400">
              <span className="font-semibold">Total to Invest:</span> ₹
              {recommendations
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-yellow-700 dark:text-yellow-400 mt-1">
              ...
              performance is no guarantee of future results. Consult a financial
                ...
                {selectedInvestment?.id === inv.id && (
                  <div className="mt-4 space-y-3 border-t border-gray-200 dark:border-gray-700 pt-3">
                    ...
                    {(() => {
                      ...
                      return (
                        /* Honest placeholder — real live fund/market data lands here once the
    backend (AMFI NAV ingestion) is wired up in a later phase. */
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-2">
                          <p className="text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">
                            Category Overview
                          </p>
                          <p className="text-xs text-gray-600 dark:text-gray-400">
                            {inv.risk ? `${inv.risk} risk · ` : ""}Based on
                            typical historical ranges for this category — live
                            data coming soon.
                          </p>
                        </div>
                      );
      ...
      <Card className="bg-linear-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20">
        <div className="space-y-2">
          ...
          <ol className="text-sm text-gray-700 dark:text-gray-300 space-y-1 list-decimal list-inside">
            <li>
              Click on an investment to see detailed analysis and market
              sentiment
            </li>
            <li>
              Click the "{recommendations[0]?.buttonText || "Open"}" button to
              visit the provider
            </li>
